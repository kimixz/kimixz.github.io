...
export default function Page() {
  return (
   ...
   <div className="flex items-center mb-8">
        <h1 className="font-medium text-3xl tracking-tighter ">Kimya Khakzad Shahandashti</h1>
        <img src="/text-work.gif" alt="My GIF" className="w-8 h-8 ml-6" />
      </div>
      <section className="mb-8">
        ...
        <p className="prose prose-neutral dark:prose-invert">
          ...
          During my research, I worked with assurance cases and I am interested in Generative AI models and LLMs.
