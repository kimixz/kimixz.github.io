        ...
        <div className="space-y-4">
          <div className="p-4 border border-gray-300 rounded-lg">
            <h2 className="font-semibold">
              <a href="https://dl.acm.org/doi/abs/10.1145/3650105.3652291" className="text-black hover:underline">
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <h2 className="font-semibold">
              <a href="https://example.com/paper2" className="text-black hover:underline">
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <h2 className="font-semibold">
              <a href="https://example.com/paper3" className="text-black hover:underline">
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <h2 className="font-semibold">
              <a href="https://example.com/paper4" className="text-black hover:underline">
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <h2 className="font-semibold">
              <a href="https://example.com/paper5" className="text-black hover:underline">
