    ...
    return (
      <section className="max-w-3xl mx-auto p-4">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <h2 className="font-semibold">
              <a href="https://example.com/paper2" target="_blank" rel="noopener noreferrer" className="text-black hover:underline">
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <h2 className="font-semibold">
              <a href="https://example.com/paper3" target="_blank" rel="noopener noreferrer" className="text-black hover:underline">
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <h2 className="font-semibold">
              <a href="https://example.com/paper4" target="_blank" rel="noopener noreferrer" className="text-black hover:underline">
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <h2 className="font-semibold">
              <a href="https://example.com/paper5" target="_blank" rel="noopener noreferrer" className="text-black hover:underline">
