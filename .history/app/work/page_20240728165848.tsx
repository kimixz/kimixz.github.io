    ...
    <section className="max-w-3xl mx-auto p-4">
      ...
      <div className="space-y-6">
        ...
        <div className="p-6 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 shadow-md">
          ...
          <ul className="list-disc ml-5 text-gray-700 dark:text-gray-300 space-y-2">
            <li>Refactored the response page of Porsline by implementing <strong>Next.js</strong> and <strong>Redux toolkit</strong>, resulting in a 60% increase in user engagement and survey creation efficiency.</li>
            <li>Enhanced test coverage to 80% by implementing tests, utilizing <strong>Jest</strong> and <strong>React Testing Library</strong>.</li>
