export default function Page() {
  return (
    <section className="max-w-3xl mx-auto p-4 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg">
      <h1 className="font-medium text-3xl mb-8 tracking-tighter text-center text-blue-600 dark:text-blue-400">Work Experience</h1>
      
      <div className="space-y-6">
        <div className="p-6 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 shadow-md hover:shadow-lg transition-shadow duration-300">
